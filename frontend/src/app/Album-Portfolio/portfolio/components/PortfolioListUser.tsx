...
export default function PortfolioListUser(){
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <span
                                            className={`inline-block text-xs px-3 py-1 rounded-full font-semibold tracking-wide ${getCategoryColor(portfolio.category)}`}>
                                        {portfolio.category}
                                    </span>
                                    </div>
